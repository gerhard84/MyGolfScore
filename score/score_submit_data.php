...
<div class="container">
  ...
  <div class="row col-md-offset-3">
    <h3 class="col-md-5 " for="course_name">Course: <?php echo $course?></h3>
    <h3 class="col-md-5" for="play_date">Date: <?php echo $date?></h3>
    <h3 class="col-md-5" for="player_name">Player: <?php echo $player?></h3>
    <h3 class="col-md-5" for="play_date" name='hcap' id='hcap'>Handicap: <?php echo $handicap[0]?></h3>
  </div>
