							...
							<div class="panel panel-primary">
								<div class="panel-heading">Front 9</div>
									<div class="panel-body">
										        ...
										        <tfoot>
										            <tr>
																	<th style="width: 10%" class="col-xs-2">Hole</th>
																	<th style="width: 20%" class="col-xs-2">Meters</th>
																	<th style="width: 20%" class="col-xs-2">Par</th>
																	<th style="width: 20%" class="col-xs-2">SI</th>
										            </tr>
										        </tfoot>
										        <tbody>
															<?php
